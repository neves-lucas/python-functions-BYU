...
'''
If your team finishes the core requirements in less than an hour, 
complete one or more of these stretch challenges. Note that the stretch challenges are optional.
...
def main():
    ...
    birth_str = input("What is your birth date? [YYYY-MM-DD] " )
    ...
    print(f"Height: {cm/100:.2f} m")
    print(f"Weight {kg:.2f} kg")
