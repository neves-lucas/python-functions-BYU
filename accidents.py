    ...
    try:
        ...
        with open(filename, "rt") as text_file:
            ...
            try:     
                if perc_reduc < 0:
                    print()
                    print("You entered an invalid percentage, this is too low.")
                    print("Run the program again and enter a percentage amount" \
                    " between 0 and 100.")
                elif perc_reduc > 100:
                    print()
                    print("You entered an invalid percentage, this is too high.")
                    print("Run the program again and enter a percentage amount" \
                    " between 0 and 100.")
        ...
        print()
        print(type(val_err).__name__, val_err, sep=": ")
        print("You entered an invalid percentage.")
        print("Run the program again and enter a percentage amount" \
                " between 0 and 100.")        
