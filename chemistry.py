def main():
	...
	formula = input("Insert the molecular formula of the sample: ")
...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
	...
	for list in symbol_quantity_list:
		for symbol in list:
			...
			symbol = list[0]
			quantity = list[1]
			atomic_mass = periodic_table_dict.get(symbol, [1])
			total_molar_mass = float(atomic_mass[1]) * float(quantity)
